...
void GuildMgr::LoadGuilds()
{
    ...
    sLog->outString("Loading guild event logs...");
    {
        ...
        CharacterDatabase.DirectPExecute("DELETE FROM guild_eventlog WHERE LogGuid > 100");
    ...
    sLog->outString("Loading guild bank event logs...");
    {
        ...
        CharacterDatabase.DirectPExecute("DELETE FROM guild_bank_eventlog WHERE LogGuid > 25");
