...
void World::LoadConfigSettings(bool reload)
{
    ...
    {
        sLog->outError("Visibility.Distance.Continents can't be less max aggro radius 45");
    ...
    {
        sLog->outError("Visibility.Distance.Instances can't be less max aggro radius 45");
    ...
    {
        sLog->outError("Visibility.Distance.BGArenas can't be less max aggro radius 45");
