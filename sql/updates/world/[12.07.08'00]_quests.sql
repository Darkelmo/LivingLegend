...
UPDATE `creature_template` SET `npcflag` = `npcflag`^2, `questItem1` = 0, `questItem2` = 0, `questItem3` = 0, `questItem4` = 0, `questItem5` = 0, `questItem6` = 0, `KillCredit1` = 0, `KillCredit2` = 0;
